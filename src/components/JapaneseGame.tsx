...
const VOCAB_DATABASE: Category[] = [
  ...
  },
  {
    id: 'greetings',
    name: '生活問候 (Greetings)',
    description: '日常生活中最常用的日語禮貌問候語',
    icon: '💬',
    items: [
      { id: 'g1', japanese: 'こんにちは', hiragana: 'こんにちは', romaji: 'konnichiwa', english: 'Hello' },
      { id: 'g2', japanese: 'ありがとう', hiragana: 'ありがとう', romaji: 'arigatou', english: 'Thank you' },
      { id: 'g3', japanese: 'すみません', hiragana: 'すみません', romaji: 'sumimasen', english: 'Excuse me / Sorry' },
      { id: 'g4', japanese: 'おはよう', hiragana: 'おはよう', romaji: 'ohayou', english: 'Good morning' },
      { id: 'g5', japanese: 'さようなら', hiragana: 'さようなら', romaji: 'sayounara', english: 'Goodbye' },
      { id: 'g6', japanese: 'おやすみ', hiragana: 'おやすみ', romaji: 'oyasumi', english: 'Good night' },
      { id: 'g7', japanese: 'はじめまして', hiragana: 'はじめまして', romaji: 'hajimemashite', english: 'Nice to meet you' },
    ]
  },
  {
    id: 'food_drink',
    name: '美食餐飲 (Food & Drinks)',
    description: '令人垂涎三尺的日式美食單字',
    icon: '🍣',
    items: [
      { id: 'f1', japanese: 'すし', hiragana: 'すし', romaji: 'sushi', english: 'Sushi' },
      { id: 'f2', japanese: 'ラーメン', hiragana: 'ラーメン', romaji: 'raamen', english: 'Ramen' },
      { id: 'f3', japanese: 'てんぷら', hiragana: 'てんぷら', romaji: 'tempura', english: 'Tempura' },
      { id: 'f4', japanese: 'おちゃ', hiragana: 'おちゃ', romaji: 'ocha', english: 'Green Tea' },
      { id: 'f5', japanese: 'みず', hiragana: 'みず', romaji: 'mizu', english: 'Water' },
      { id: 'f6', japanese: 'さけ', hiragana: 'さけ', romaji: 'sake', english: 'Japanese Sake' },
      { id: 'f7', japanese: 'べんとう', hiragana: 'べんとう', romaji: 'bentou', english: 'Bento (Lunchbox)' },
    ]
  },
  {
    id: 'travel_places',
    name: '旅遊出行 (Travel & Places)',
    description: '日本自助旅行必備的實用場所與交通單字',
    icon: '✈️',
    items: [
      { id: 't1', japanese: 'えき', hiragana: 'えき', romaji: 'eki', english: 'Station' },
      { id: 't2', japanese: 'くうこう', hiragana: 'くうこう', romaji: 'kuukou', english: 'Airport' },
      { id: 't3', japanese: 'ホテル', hiragana: 'ホテル', romaji: 'hoteru', english: 'Hotel' },
      { id: 't4', japanese: 'でんしゃ', hiragana: 'でんしゃ', romaji: 'densha', english: 'Train' },
      { id: 't5', japanese: 'きっぷ', hiragana: 'きっぷ', romaji: 'kippu', english: 'Ticket' },
      { id: 't6', japanese: 'タクシー', hiragana: 'タクシー', romaji: 'takushii', english: 'Taxi' },
      { id: 't7', japanese: 'ちず', hiragana: 'ちず', romaji: 'chizu', english: 'Map' },
    ]
  }
];
